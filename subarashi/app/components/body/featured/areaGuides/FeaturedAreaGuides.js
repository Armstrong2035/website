        ...
        <Box
          sx={{
            ...
            '&::after': {
              ...
              right: 0,
              height: '1px',
              background: 'linear-gradient(to right, #005244 0%, transparent 100%)',
              opacity: 0.2,
            },
          }}
        >
        ...
        <Grid 
          ...
          sx={{
            ...
            '&::before': {
              ...
              background: 'radial-gradient(circle at center, rgba(0,82,68,0.03) 0%, transparent 70%)',
              zIndex: -1,
              pointerEvents: 'none',
            },
          }}
          ...
          {featuredGuides.map((guide) => (
            <Grid
              ...
              sx={{
                ...
                transform: hoveredCardId === guide.id ? 'translateY(-8px)' : 'none',
              }}
            >
              <FeaturedAreaGuideCard guide={guide} isHovered={hoveredCardId === guide.id} />
            </Grid>
          ))}
        </Grid>
      </Box>
