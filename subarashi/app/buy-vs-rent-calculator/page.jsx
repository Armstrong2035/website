      ...
      >
        ...
        <Container sx={{ mt: 5, mb: 5 }}>
          ...
          <Container maxWidth="xl" sx={{ position: "relative", mt: 5 }}>
            ...
            <Typography
              sx={{
                ...typographyStyles.featureText,
                color: "#F2FFC2",
                mb: 6,
                textAlign: "center",
              }}
            >
              If you're thinking about buying a property instead of continuing
              to rent, use our buy-to-rent calculator to help you determine
              which option is more beneficial for you.
            </Typography>

            <Paper
              elevation={3}
              sx={{ p: 4, borderRadius: 2, backgroundColor: "#005244" }}
            >
              <Grid container spacing={4}>
                <Grid item xs={12} md={6}>
                  <Paper
                    elevation={0}
                    sx={{ p: 3, backgroundColor: "#edfceb", borderRadius: 2 }}
                  >
                    <CalculatorInputs
                      inputs={inputs}
